...
{
    LL_USART_EnableIT_RXNE(USART2);  //打开串口2的中断接受  
	LL_USART_EnableIT_PE(USART2);

	HAL_GPIO_WritePin(ESP_RST_GPIO_Port,ESP_RST_Pin,GPIO_PIN_RESET);//复位一下
	HAL_Delay(250);
	HAL_GPIO_WritePin(ESP_RST_GPIO_Port,ESP_RST_Pin,GPIO_PIN_SET);
	HAL_Delay(500);

	ESP8266_Clear(); //清除一下缓存
    OLED_ShowString(35,1,(uint8_t *)"ESP8266",16);
    OLED_ShowCHinese(33,3,7);OLED_ShowCHinese(49,3,8);OLED_ShowCHinese(65,3,9);OLED_ShowCHinese(81,3,10);//oled显示“ESP8266初始化中”
  ...
  OLED_ShowCHinese(24,3,7);OLED_ShowCHinese(40,3,8);OLED_ShowCHinese(56,3,9);OLED_ShowCHinese(72,3,11);OLED_ShowCHinese(88,3,12);//oled显示“ESP8266初始化完成”
}
...
void ESP8266_IRQHandler(void)
{
	...
	if(LL_USART_IsActiveFlag_RXNE(USART2)) //接收中断
	{
