...
void show(void)
{
	...
	OLED_ShowCHinese(0,2,5); OLED_ShowCHinese(16,2,6);//光照
	OLED_ShowCHinese(64,2,19); OLED_ShowCHinese(80,2,20);//音量 	
	OLED_ShowCHinese(0,4,30); OLED_ShowCHinese(16,4,31);OLED_ShowCHinese(32,4,32);OLED_ShowCHinese(48,4,24);//烟雾检测
	OLED_ShowCHinese(0,6,24); OLED_ShowCHinese(16,6,33);OLED_ShowCHinese(32,6,25);OLED_ShowCHinese(48,6,34);//测量距离
