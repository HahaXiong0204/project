...
#define  PRODUCTID            "588384"                                    //产品ID,Username
#define  PRODUCTID_LEN        strlen(PRODUCTID)                             //产品ID长度
#define  DEVICEID             "1064133490"                                     //设备ID ,ClientID 
#define  DEVICEID_LEN         strlen(DEVICEID)                              //长度
#define  AUTHENTICATION       "123456"                                        //鉴权信息/密码,Passward
#define  AUTHENTICATION_LEN    strlen(AUTHENTICATION)                       //鉴权信息长度/密码长度 

//#define  PRODUCTID            "545022"                                    //产品ID,Username
//#define  PRODUCTID_LEN        strlen(PRODUCTID)                             //产品ID长度
//#define  DEVICEID             "999159019"                                     //设备ID ,ClientID 
//#define  DEVICEID_LEN         strlen(DEVICEID)                              //长度
//#define  AUTHENTICATION       "lcs15616432390"                                        //鉴权信息/密码,Passward
//#define  AUTHENTICATION_LEN    strlen(AUTHENTICATION)                       //鉴权信息长度/密码长度 
#define  S_TOPIC_NAME         "one"                                   //订阅的主题  
//#define  P_TOPIC_NAME         "topic_two" 
#define  Data_TOPIC_NAME      "$dp"                                         //发布的主题
#define	 MQTTServerIP	        "183.230.40.39"
#define  MQTTServerPort       6002  
//#define	 MQTTServerIP	        "192.168.43.174"
