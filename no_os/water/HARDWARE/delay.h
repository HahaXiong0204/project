...
extern uint16_t year_time_start;
extern uint8_t moon_time_start;
extern uint8_t sun_time_start;
extern uint8_t hour_time_start;   // 小时
extern uint8_t minute_time_start;  // 分钟
extern uint8_t second_time_start;  // 秒
