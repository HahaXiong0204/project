...
uint16_t year_time_start =0;
uint8_t  moon_time_start = 0;
uint8_t  sun_time_start = 0;
uint8_t  hour_time_start = 0;   // 小时
uint8_t  minute_time_start = 0;  // 分钟
uint8_t  second_time_start = 0;  // 秒
...
void time_rest(void)
{
	year_time = year_time_start = 0;  // 年
    moon_time = moon_time_start = 0;  // 月
    sun_time = sun_time_start = 0;    // 日
    hour_time = hour_time_start = 0;  // 小时
    minute_time = minute_time_start = 0;  // 分钟
    second_time = second_time_start = 0;  // 秒
}
