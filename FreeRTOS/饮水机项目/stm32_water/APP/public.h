...
extern double temperature_ds18;             //温度
...
extern uint8_t red_people;   // 人体传感器  0无人  1有人
...
extern uint8_t fire_flag;   // 火焰标志位
extern uint8_t approch_switch;  // 接近开关 1 没有铁，0，有铁
extern uint8_t approch_flag;    // 接近开关的标志位

extern int TH_Temp;   //  温度阈值
extern int TL_Temp;    // 最低温度
// ================================================================

extern float Water_Hot_temp;   // 模拟热水温度
// ============================= 传感器的阈值 ====================
extern int TH_Temp;   //  温度阈值
...
extern uint16_t Water_h; // 高水位
extern uint16_t Water_l; // 低水位
extern uint16_t Water_c ; // 当前水位

extern uint16_t Water_TDS1;   // 水源水质
extern uint16_t Water_TDS2;   // 饮水水质

extern uint8_t Error_flag;   // 错误标志位
extern uint8_t Warning_flag;  // 警告标志位

extern float Water_Hot;   // 热水温度

extern uint8_t Water_flow;   // 单位时间水流量
extern uint8_t Hot_flag;  // 加热标志位

extern uint8_t Water_switch;    // 关水

extern uint8_t Water_leve_flag;  // 抽水水平 0 不抽 1抽水



#define WATER_ONE_MAX   120
extern uint16_t Water_all;    // 饮水总量
extern uint16_t Water_one_all;   // 单次饮水总量

extern uint8_t jiesuan_flag;   // 结算标志位
// ============================ user end ==============================

// =========================== 系统 ===============================================
extern char time_buff[56];     // 拼装时间
extern uint8_t *PROID_Device; 
extern char start_time_buff[56];   // 开始用水时间
// ==============================================================================
