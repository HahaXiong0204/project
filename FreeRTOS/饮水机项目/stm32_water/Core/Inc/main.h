...
#define red_input_Pin GPIO_PIN_12
#define red_input_GPIO_Port GPIOH
#define TRIG_Pin GPIO_PIN_12
#define TRIG_GPIO_Port GPIOD
#define machia_pwm_Pin GPIO_PIN_8
#define machia_pwm_GPIO_Port GPIOC
#define approach_switch_Pin GPIO_PIN_14
#define approach_switch_GPIO_Port GPIOH
