...
{
	sprintf(buff,"%d-%d-%d-%d-%d-%d",year_time,moon_time,sun_time,hour_time,minute_time,second_time);
}
...
void Analysis_Time(char *buff_time)
{
	...
	*/
	...
	time_init_temp(year_time,moon_time,sun_time,hour_time,minute_time,second_time);  
}
