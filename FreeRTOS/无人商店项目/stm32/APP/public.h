...
extern int Water_num;   // 矿泉水 数量
extern float Water_p;   // 饮水机价格
extern int bingan_num;   // 饼干数量
extern float bingan_p;  // 饼干价格
extern int yinlian_num;  // 饮料 数量
extern float yinliao_p;  // 饮料价格

extern int Water_g;   // 矿泉水购买量
extern int bingan_g;  // 饼干购买量
extern int yinliao_g; // 饮料价格
extern uint8_t stor_flag; //  商品标号

#define MAX_NUM 3

extern uint8_t nua ;
extern float calu_num;    // 计算总价
extern uint8_t people_flag;
// ============================ user end ==============================
