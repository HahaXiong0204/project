...
#define PROID		"588428"   //产品ID

#define AUTH_INFO	"123456"		//鉴权信息

#define DEVID		"1064291044"	//设备ID
...
int a = 0;
extern int  wendu1,wendu2;	//温度1温度2 
extern int  yw1,yw2;//yw1yw2  
extern int hy1,hy2;//0无火  1有火
...
//	strcat(buf, text);
    ...
    memset(text, 0, sizeof(text));
	sprintf(text, "temperature1,%d;", wendu1);          //数据
	strcat(buf, text);
    
    memset(text, 0, sizeof(text));
	sprintf(text, "temperature2,%d;", wendu2);          //数据
	strcat(buf, text);
    
    memset(text, 0, sizeof(text));
	sprintf(text, "smog1,%d;", yw1);          //数据
	strcat(buf, text);
    
    memset(text, 0, sizeof(text));
	sprintf(text, "smog2,%d;", yw2);          //数据
	strcat(buf, text);
    
    memset(text, 0, sizeof(text));
//    if(hy1==0)
//    {
//        sprintf(text, "fire1,%s;", "无火");          //数据
//    }
//    else
//    {
//        sprintf(text, "fire1,%s;", "有火");          //数据
//    }
    sprintf(text, "fire1,%d;", hy1);          //数据
	strcat(buf, text);
    
    memset(text, 0, sizeof(text));
//    if(hy2==0)
//    {
//        sprintf(text, "fire2,%s;", "无火");          //数据
//    }
//    else
//    {
//        sprintf(text, "fire2,%s;", "有火");          //数据
//    }
    sprintf(text, "fire2,%d;", hy2);          //数据
	strcat(buf, text);
...
//	
//    memset(text, 0, sizeof(text));
//	sprintf(text, "air_quality,%d;", a++);          //烟雾浓度数据
//	strcat(buf, text);
//    
